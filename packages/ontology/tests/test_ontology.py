...
def test_five_elements_present(ontology) -> None:
    assert set(ontology.ngu_hanh) == {"kim", "moc", "thuy", "hoa", "tho"}


def test_sinh_cycle_closes(ontology) -> None:
...
def test_khac_cycle_closes(ontology) -> None:
...
def test_eight_cung_menh_present(ontology) -> None:
    assert len(ontology.cung_menh) == 8


def test_cung_menh_groups_split_four_four(ontology) -> None:
...
def test_bat_trach_has_64_entries(ontology) -> None:
    assert len(ontology.bat_trach) == 64


def test_bat_trach_covers_every_pair(ontology) -> None:
...
def test_bat_trach_for_cung_returns_eight(ontology) -> None:
    for cung_key in ontology.cung_menh:
        rels = bat_trach_for_cung(cung_key, ontology)
        assert len(rels) == 8


def test_each_cung_has_phuc_vi_at_its_home(ontology) -> None:
...
def test_each_cung_has_one_sinh_khi_one_tuyet_menh(ontology) -> None:
    for cung_key in ontology.cung_menh:
        rels = bat_trach_for_cung(cung_key, ontology)
...
def test_score_sum_is_zero_per_cung(ontology) -> None:
